      ...
      <div className="fixed z-20 h-16 w-full  bg-white py-1 lg:h-24">
         ...
         <div className=" container m-auto  flex max-w-[1440px] items-center justify-between p-2 ">
            <div className="">
               ...
               <nav
                  className={`' absolute z-50 flex  w-screen flex-col justify-between rounded-b-xl bg-white py-4 pl-7 transition-all lg:static  lg:z-50 lg:w-auto lg:flex-row  lg:flex-wrap lg:items-center lg:py-0 lg:pl-0 lg:opacity-100   ${
