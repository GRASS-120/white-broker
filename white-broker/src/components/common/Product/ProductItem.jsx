const ProductItem = ({ text }) => {
   return (
      <div className=" relative mx-6 my-6 min-h-[340px] md:min-h-[390px] md:max-w-[360px] rounded-xl bg-gradient-to-tr from-[#BD00FF] to-[#0276FF] p-5 text-xs text-white transition-all hover:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] sm:h-[370px] sm:text-base">
         ...
         <div>
            <div className="absolute bottom-16 flex w-3/4 justify-between items-center sm:flex-row sm:items-center">
               <div>
            ...
            <button className="absolute bottom-5 min-w-[220px] rounded-xl bg-[#fff] p-2 font-bold text-[#0276FF] transition-all hover:brightness-125 sm:w-full sm:max-w-[320px]">
               ОСТАВИТЬ ЗАЯВКУ
            </button>
         </div>
      </div>
