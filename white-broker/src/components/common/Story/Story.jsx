        ...
        <div className='bg-[#5B41FF]'>
            <div className='max-w-[1440px] m-auto flex flex-col sm:flex-row justify-center'>
                ...
                <div className='my-10 mx-3'>
                    ...
                    <button className='bg-[#fff] w-full md:w-5/6 md:text-xl lg:text-4xl font-semibold text-[#0276FF] p-3 rounded-xl transition-all hover:brightness-125 shadow-md'>{mainPageData.creditHistory.buttonText}</button>
                </div>
            </div>
