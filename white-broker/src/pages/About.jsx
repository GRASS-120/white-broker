   ...
   return (
      <div className="m-auto mt-24 max-w-[1440px] font-semibold tracking-wide">
         ...
         <p className=" select-none text-white">
            надежный брокер, взять кредит через брокера в крыму, взять кредит
            через брокера в москве, ялте, махачкале, симферополе, севастополе,
            Керчи, Евпатории, брокерские услуги, займ для бизнеса через брокера,
            брокерский кредит под залог, кредит для поставщиков маркетплейса
            через брокера,проверить кредитную историю, консультация по кредиту,
            владикавказ, кредит выгодно, кредит под низкую ставку, брокер москва
         </p>
      </div>
   );
};
